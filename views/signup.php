            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="signup_ok.php" method="post" name="signup" role="form" >
                            <fieldset>
                               <div class="form-group">
                                ...
                                <hr>
                                <button type="submit" name="button" class="btn btn-lg btn-success btn-block" value="submit" >확인</button>
